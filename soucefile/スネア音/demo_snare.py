...
def ov(data, samplerate, Fs, overlap):
    ...
    for i in range(N_ave):
        ...
        final_time.append((ps + Fs)/samplerate)
...
path = '../../sound/snare1.wav'                         #ファイルパスを指定
...
fft_array = fft_ave(time_array, samplerate, Fs, N_ave, acf)

exit()

spec_dt = final_time / N_ave

freq_index, freq_peaks, time_index = findpeaks_2d(fft_array, spec_dt, fft_axis[1], num_peaks=100, w=10, max_peaks=1)
